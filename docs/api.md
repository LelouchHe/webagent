...
| `inbox_count_changed`   | `pendingCount`                                                                           | Authoritative pending inbox count after a mutation or TTL cleanup. Delivered globally, including session-scoped SSE clients |

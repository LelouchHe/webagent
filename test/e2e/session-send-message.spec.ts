...
test("sending a prompt shows the user message and streamed assistant reply", async ({ page }) => {
  ...
  await expect(page.locator(".msg.assistant").last()).toContainText("Echo: hello from e2e");

...
test("autopilot behavior syncs across two clients in the same session", async ({ browser }) => {
  ...
  await sendPrompt(pageB, "E2E_PERMISSION autopilot should approve across tabs");

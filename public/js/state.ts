...
export const dom = {
  ...
  fileViewer: $<HTMLElement>("#file-viewer"),
  fileViewerPath: $<HTMLSpanElement>("#file-viewer-path"),
  fileViewerClose: $<HTMLButtonElement>("#file-viewer-close"),
  fileViewerNotice: $<HTMLDivElement>("#file-viewer-notice"),
  fileViewerContent: $<HTMLDivElement>("#file-viewer-content"),
